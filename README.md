...
- **训练动画回放** —— 梯度下降类算法（逻辑回归/SVM/感知机/Softmax/MLP/线性/多项式/Lasso 回归）逐迭代决策边界与拟合曲线演化 + 损失曲线同步，K-Means 质心移动轨迹
- **源码即看** —— 页面内"查看源码"按钮直接展开当前算法的 Python 实现，边看效果边读代码
...
- **2026-08-15**：8 个梯度下降算法新增训练动画（决策边界/拟合曲线逐迭代演化）；新增页面内"查看源码"面板；支持 Render 一键部署与在线演示；修复动画控制条在无动画算法下误显示的 bug
